...
public class Archer {}/*extends GameCharacter {
    ...
    public Archer(String name, String characterClass)
    {
        ...
        setIntValue(generateRandomNumber(min,max));
        setStr(generateRandomNumber(min,max));
        setWis(generateRandomNumber(min,max));
        setCha(generateRandomSequence(min,max).min().getAsInt());
        setDex(generateRandomSequence(min,max).max().getAsInt());
